...
const I18N = {
  en: {
    ...
    'be.localNotApproved': 'MCP enabled, but the approval could not be written to ~/.claude.json — Claude Code will ask before loading it.',
  ...
  pt: {
    ...
    'be.localNotApproved': 'MCP habilitado, mas não deu pra gravar a aprovação no ~/.claude.json — o Claude Code vai perguntar antes de carregar.',
