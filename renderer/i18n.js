...
const I18N = {
  en: {
    ...
    'detail.flags': 'Flags',
    'be.serverStarted': 'Server for {0} is up on port {1}.',
    'be.serverStopped': 'Server for {0} stopped.',
    'be.serverNotRunning': 'Server for {0} was not running.',
    'be.serverStartFail': 'Could not start the server for {0}: {1}',
    'detail.server': 'MCP server',
    'server.up': 'up on port {0}',
    'server.down': 'stopped — the MCP will not answer until it is up',
    'server.start': 'Start server',
    'server.stop': 'Stop server',
    'server.restarted': 'Server restarted with the new cookie — an open conversation reconnects on its own.',
    'server.startedMany': '{0} MCP server(s) up.',
    'server.badge': 'MCP server running on port {0}',
  ...
  pt: {
    ...
    'detail.flags': 'Flags',
    'be.serverStarted': 'Servidor de {0} no ar na porta {1}.',
    'be.serverStopped': 'Servidor de {0} parado.',
    'be.serverNotRunning': 'O servidor de {0} nao estava rodando.',
    'be.serverStartFail': 'Nao deu pra subir o servidor de {0}: {1}',
    'detail.server': 'Servidor MCP',
    'server.up': 'no ar na porta {0}',
    'server.down': 'parado — o MCP nao responde ate ele subir',
    'server.start': 'Subir servidor',
    'server.stop': 'Parar servidor',
    'server.restarted': 'Servidor reiniciado com o cookie novo — conversa aberta reconecta sozinha.',
    'server.startedMany': '{0} servidor(es) MCP no ar.',
    'server.badge': 'Servidor MCP rodando na porta {0}',
