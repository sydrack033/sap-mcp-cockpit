...
const I18N = {
  en: {
    ...
    'diag.sdk.hintX86': 'Found sapnwrfc.dll, but it is the 32-bit build — it can never load into an x64 Python. That is the SysWOW64 copy left by the 32-bit SAP GUI. You need the x64 one: install SAP GUI 8.00 64-bit with the RFC libraries component, or download the NW RFC SDK 7.50 (x64) and point the folder above at it.',
    ...
    'be.bridgeNoPyrfc': 'pyrfc could not be loaded. Run the bridge diagnostics in Settings — usually a missing pyrfc, or the NW RFC SDK not on PATH.',
  ...
  pt: {
    ...
    'diag.sdk.hintX86': 'Achei a sapnwrfc.dll, mas é a de 32 bits — ela nunca vai carregar num Python x64. É a cópia da SysWOW64 que o SAP GUI 32 bits deixa. Você precisa da x64: instale o SAP GUI 8.00 64 bits com o componente das bibliotecas RFC, ou baixe o NW RFC SDK 7.50 (x64) e aponte a pasta acima.',
    ...
    'be.bridgeNoPyrfc': 'Não consegui carregar o pyrfc. Rode o diagnóstico do bridge nas Configurações — costuma ser pyrfc faltando, ou o NW RFC SDK fora do PATH.',
