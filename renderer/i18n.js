...
const I18N = {
  en: {
    ...
    'btn.openIn': 'Open in',
    'btn.openIn.title': 'Opens the project folder in VSCode, or starts Claude Code / Codex in a new terminal at that folder.',
    ...
    'settings.claude': 'Claude Code command',
    'settings.codex': 'Codex command',
    'settings.cli.hint': 'Claude Code and Codex are CLIs: <b>Open in</b> starts them in a new terminal at the project folder. Leave the plain name if it is on PATH, or point to the full path.',
    ...
    'be.openedClaude': 'Claude Code started in a terminal at {0}.',
  ...
  pt: {
    ...
    'btn.openIn': 'Abrir em',
    'btn.openIn.title': 'Abre a pasta do projeto no VSCode, ou sobe o Claude Code / Codex num terminal novo nessa pasta.',
    ...
    'settings.claude': 'Comando do Claude Code',
    'settings.codex': 'Comando do Codex',
    'settings.cli.hint': 'Claude Code e Codex são CLIs: o <b>Abrir em</b> sobe cada um num terminal novo já na pasta do projeto. Deixe o nome solto se estiver no PATH, ou aponte o caminho completo.',
    ...
    'be.openedClaude': 'Claude Code iniciado num terminal em {0}.',
