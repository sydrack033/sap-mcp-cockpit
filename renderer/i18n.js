...
const I18N = {
  en: {
    ...
    'btn.openIn': 'Open in',
    'btn.openIn.title': 'Opens the project folder in VSCode, opens the Claude desktop app on the Code tab, or starts Codex in a new terminal at that folder.',
    ...
    'be.globalAdded': '{0} registered globally in {1}. Restart the MCP host.',
    'be.globalUpdated': '{0} updated in the global config ({1}). Restart the MCP host.',
  ...
  pt: {
    ...
    'btn.openIn': 'Abrir em',
    'btn.openIn.title': 'Abre a pasta do projeto no VSCode, abre o app do Claude na aba Code, ou sobe o Codex num terminal novo nessa pasta.',
    ...
    'be.globalAdded': '{0} registrado globalmente em {1}. Reinicie o host MCP.',
    'be.globalUpdated': '{0} atualizado na config global ({1}). Reinicie o host MCP.',
