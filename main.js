...
function protocoloChamados() {
  return [
    ...
    '',
    'Este workspace e de **um cliente**. Quando o trabalho pertence a um **chamado**,',
    'o protocolo abaixo vale. Trabalho avulso — uma consulta, uma analise pontual —',
    'segue normal: nao empurre processo em quem nao pediu.',
    '',
    '1. **Descubra qual chamado.** O usuario diz o ID, ou ele aparece no caminho do',
    '   arquivo anexado (ex.: `.../Chamados/DEL-R2R-018/spec.pptx`).',
    '   - Nao disse e ha chamados em `chamados/`? Liste e pergunte em qual estamos',
    '     antes de comecar — errar de chamado custa mais que uma pergunta.',
    '   - Nao disse e `chamados/` esta vazio ou nao existe? **Atenda o pedido**',
    '     normalmente. Sugira abrir um HANDOFF so se o trabalho for durar mais que',
    '     esta conversa.',
