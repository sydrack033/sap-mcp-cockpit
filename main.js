...
function protocoloChamados() {
  return [
    ...
    '',
    '## Carregue a skill do dominio antes de escrever',
    '',
    'Skills sao *model-invoked*: se ninguem mandar, o agente resolve de cabeca e',
    'deixa na mesa conhecimento curado que e melhor que o default dele.',
    '',
    '| Vai escrever ou alterar | Carregue antes |',
    '|---|---|',
    '| ABAP (classe, report, include, funcao) | `sap-abap` |',
    '| CDS view / view entity | `sap-abap-cds` |',
    '| iFlow, CPI, mapping | `iflow` |',
    '| Integration Suite (API Mgmt, Event Mesh, adapters) | `sap-btp-integration-suite` |',
    '| Formulario Adobe (`.xdp`, XFA) | `sap-forms-xdp` |',
    '| Fiori / UI5 | `sap-fiori-tools`, `fiori-base`, `sapui5-cli` |',
    '| CAP | `sap-cap-capire` |',
    '',
    'Vale para **escrever ou alterar**. So ler um objeto, ou responder uma duvida',
    'rapida, nao justifica o custo.',
    '',
    '*(Skills existem no Claude Code. No Codex esta secao nao se aplica — o resto',
    'do protocolo vale igual.)*',
    '',
