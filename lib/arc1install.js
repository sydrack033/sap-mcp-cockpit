...
// O npm vem junto com o node. Chamamos o npm-cli.js pelo node em vez do
// `npm.cmd`: .cmd no Windows obriga shell:true, e com shell os argumentos viram
// uma string nao escapada -- um caminho com espaco ja quebraria o comando.
function npmCli(nodeBin) {
...
module.exports = {
  PACOTE, NODE_MINIMO,
  home, nodeInfo, instaladas, ativa, ativar, runtime, status,
