...
module.exports = {
  ...
  instructions(envs) {
    ...
    L.push('');
    L.push('Workspace de **um cliente**: acesso aos sistemas SAP dele pelo **ARC-1** como');
    L.push('servidores **MCP**, mais o contexto de trabalho dos chamados. Veja o Protocolo');
    L.push('de trabalho no fim deste arquivo.');
    L.push('');
